...
let mouseUp$ = fromEvent(document, 'mouseup').pipe(
    tap(()=>draggable.style.backgroundColor="#06883c"),
);
...
mouseDown$.pipe(
    tap(()=>draggable.style.backgroundColor="#6edc9c"),
...
function onMouseDown(e, item) {  
  ...
  item.style.backgroundColor = "#6edc9c";
}

function onMouseUp(e, item) {
    
  isMouseDown = false;
  item.style.backgroundColor = "#06883c";
}
